  ...
  return (
    <div className="max-w-3xl space-y-6">
      <header>
        ...
        <p className="mt-6 text-sm font-semibold uppercase tracking-wide text-face-red">Nueva apertura</p>
        <h1 className="mt-1 text-2xl font-bold text-face-blue">Nueva materia</h1>
